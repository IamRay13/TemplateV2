...
RSWNY Cheektowaga
`,
            dynamic: `The machine you have is a concentrator with a HomeFill unit that sits on top of the concentrator, allowing you to refill your own tanks. Correct?
...
`
	           ...
	           priorAuth: {
            static: `[Scheduling] Sent an email to the local office CODE, to ask them who is the person who works in getting the authorization from the patient's insurance.
`,
